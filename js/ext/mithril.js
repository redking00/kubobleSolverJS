...
(function () {
        ...
        if (input.length) {
            ...
            for (var i = 1; i < input.length; i++) {
                if ((input[i] != null && input[i].key != null) !== isKeyed) {
                    throw new TypeError(isKeyed && (input[i] != null || typeof input[i] === "boolean")
    ...
    var hyperscriptVnode = function () {
        ...
        if (arguments.length === start + 1) {
            ...
            if (!Array.isArray(children0))
                children0 = [children0];
        }
        else {
            children0 = [];
            while (start < arguments.length)
                children0.push(arguments[start++]);
        }
        return Vnode("", attrs1.key, attrs1, children0);
    };
    ...
    var _13 = function ($window) {
        ...
        function setAttr(vnode3, key, old, value, ns, isFileInput) {
            if (key === "key" || key === "is" || value == null || isLifecycleMethod(key) || (old === value && !isFormAttribute(vnode3, key)) && typeof value !== "object" || key === "type" && vnode3.tag === "input")
                return;
            if (key[0] === "o" && key[1] === "n")
            ...
            if (key.slice(0, 6) === "xlink:")
                ...
                if (key === "value") {
                    ...
                    if ((vnode3.tag === "input" || vnode3.tag === "textarea") && vnode3.dom.value === "" + value && (isFileInput || vnode3.dom === activeElement()))
                        return;
